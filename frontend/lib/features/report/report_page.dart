...
class _ReportPageState extends State<ReportPage> {
  ...
  Future<void> _submit() async {
    ...
    try {
      final res = await ApiService.createReport({
        'type': _selectedType,
      ...
      if (res.statusCode == 200 || res.statusCode == 201) {
        ...
        setState(() { _isAnonymous = false; _evidence = null; });
      } else {
      ...
      builder: (_) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            Text('Laporan Anda telah diterima dan akan segera ditangani.',
  ...
  Widget _textField(String hint, TextEditingController ctrl) => TextField(
    controller: ctrl,
    decoration: InputDecoration(
      hintText: hint,
      hintStyle: TextStyle(color: AppColors.textMuted, fontSize: 13),
